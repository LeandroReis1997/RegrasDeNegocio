        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Endereco_CEP_CEP = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fornecedres", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Produtos_Fornecedres_IdFornecedor",
                        column: x => x.IdFornecedor,
                        principalTable: "Fornecedres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fornecedres_Apelido",
                table: "Fornecedres",
                column: "Apelido",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Fornecedres_CpfCnpj",
                table: "Fornecedres",
                column: "CpfCnpj",
                unique: true);
